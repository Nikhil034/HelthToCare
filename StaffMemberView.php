...
<html lang="en">
<head>
  <title>Staff Member Profile View</title>
  <meta charset="utf-8">
...
<div class="d-flex p-2 bg-info text-white">
  ...
  Address :  <?php echo $row['Address'];?>
    ...
    <div class="card-footer">
      <a href="EditProfileofStaffMember.php?i=<?php echo $row['Name'];?>" class="btn btn-success">Edit
...
&nbsp
      <a href="DeleteStaffMember.php?i=<?php echo $row['Sid'];?>" class="btn btn-danger">Delete
